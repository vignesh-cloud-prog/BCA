...
else if(p1<=500 && p1>=251)
millcloth=millcloth+p1*0.050f;
else if(p1<=750 && p1>501)
millcloth=millcloth+p1*0.075f;
else if(p1>750)
millcloth=millcloth+p1*0.10f;
else
millcloth=millcloth+p1*0.0f;
System.out.println("\n The purchase value for mill item of the customer is "+p1+" and discount amount is "+millcloth+"\n");
break;
case 2:
...
System.out.println("the customer is "+Totalvalue+" discount is "+TD+"\n");
